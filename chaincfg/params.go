...
var (
	...
	// mainPowLimit is the highest proof of work value a Brocoin block can
	// have for the main network.  It is the value 2^224 - 1.
	mainPowLimit, _ = new(big.Int).SetString("0x0fffff000000000000000000000000000000000000000000000000000000", 0)

	// regressionPowLimit is the highest proof of work value a Brocoin block
	// can have for the regression test network.  It is the value 2^255 - 1.
	regressionPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 255), bigOne)

	// testNet3PowLimit is the highest proof of work value a Brocoin block
	// can have for the test network (version 3).  It is the value
	// 2^224 - 1.
	testNet3PowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// simNetPowLimit is the highest proof of work value a Brocoin block
...
// Params defines a Brocoin network by its parameters.  These parameters may be
// used by Brocoin applications to differentiate networks as well as addresses
...
// MainNetParams defines the network parameters for the main Brocoin network.
var MainNetParams = Params{
	...
	DNSSeeds: []DNSSeed{
		...
		//{"dnsseed.brocoin.dashjr.org", false},
		//{"seed.bitcoinstats.com", true},
		//{"seed.bitnodes.io", false},
		//{"seed.brocoin.jonasschnelli.ch", true},
	},
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		{2016, newHashFromStr("000009e20e36e9d5a4f596696d61dc96cd82400df214e28292f26d44afdd635a")},
...
// Brocoin network.  Not to be confused with the test Brocoin network (version
...
// TestNet3Params defines the network parameters for the test Brocoin network
...
var TestNet3Params = Params{
	...
	DNSSeeds: []DNSSeed{
		{"207.180.196.129", true},
		//{"testnet-seed.brocoin.schildbach.de", false},
...
// SimNetParams defines the network parameters for the simulation test Brocoin
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Brocoin
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Brocoin network")
...
// Register registers the network parameters for a Brocoin network.  This may
