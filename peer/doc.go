...
/*
Package peer provides a common base for creating and managing Brocoin network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the brocoin wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe brocoin peer for handling brocoin
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of brocoin protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling brocoin protocol messages
...
caller to specify things such as the user agent name and version, the brocoin
network to use, which services it supports, and callbacks to invoke when brocoin
...
In order to do anything useful with a peer, it is necessary to react to brocoin
...
For convenience, a callback hook for all of the currently supported brocoin
...
(https://godoc.org/github.com/brronsuite/brond/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
