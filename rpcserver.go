...
func handleCreateRawTransaction(s *rpcServer, cmd interface{}, closeChan <-chan struct{}) (interface{}, error) {
	...
	for encodedAddr, amount := range c.Amounts {
		...
		if amount <= 0 || amount > bronutil.MaxSatoshi {
			return nil, &btcjson.RPCError{
...
func createTxRawResult(chainParams *chaincfg.Params, mtx *wire.MsgTx,
	...
	if blkHeader != nil {
		// This is not a typo, they are identical in brocoind as well.
...
//
// See https://en.brocoin.it/wiki/BIP_0022 for more details.
...
func handleGetBlockTemplateRequest(s *rpcServer, request *btcjson.TemplateRequest, closeChan <-chan struct{}) (interface{}, error) {
	...
	if !(cfg.RegressionTest || cfg.SimNet) &&
		...
		return nil, &btcjson.RPCError{
			...
			Message: "Brocoin is not connected",
		}
	}
	...
	if currentHeight != 0 && !s.cfg.SyncMgr.IsCurrent() {
		return nil, &btcjson.RPCError{
			...
			Message: "Brocoin is downloading blocks...",
		}
	}
...
//
// See https://en.brocoin.it/wiki/BIP_0023 for more details.
...
//
// See https://en.brocoin.it/wiki/BIP_0022 and
// https://en.brocoin.it/wiki/BIP_0023 for more details.
...
func handleSearchRawTransactions(s *rpcServer, cmd interface{}, closeChan <-chan struct{}) (interface{}, error) {
	...
	for i := range addressTxns {
		...
		if blkHeader != nil {
			// This is not a typo, they are identical in Brocoin
			// Core as well.
...
func handleVerifyMessage(s *rpcServer, cmd interface{}, closeChan <-chan struct{}) (interface{}, error) {
	...
	pk, wasCompressed, err := btcec.RecoverCompact(btcec.S256(), sig,
		expectedMessageHash)
	if err != nil {
		// Mirror Brocoin Core behavior, which treats error in
	...
	if err != nil {
		// Again mirror Brocoin Core behavior, which treats error in public key
...
// standardCmdResult checks that a parsed command is a standard Brocoin JSON-RPC
...
func (s *rpcServer) jsonRPCRead(w http.ResponseWriter, r *http.Request, isAdmin bool) {
	...
	// Terminate with newline to maintain compatibility with Brocoin Core.
