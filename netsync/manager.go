...
import (
	...
	peerpkg "github.com/brronsuite/brond/peer"
...
// blockMsg packages a brocoin block message and the peer it came from together
...
// txMsg packages a brocoin tx message and the peer it came from together
// so the block handler has access to that information.
type txMsg struct {
	tx    *bronutil.Tx
	peer  *peerpkg.Peer
