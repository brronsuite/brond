...
//
// This compact form is only used in brocoin to encode unsigned 256-bit numbers
// which represent difficulty targets, thus there really is not a need for a
// sign bit, but it is implemented here to stay consistent with brocoind.
func CompactToBig(compact uint32) *big.Int {
```
...
commits](https://github.com/brronsuite/brond/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/brronsuite/brond/graphs/contributors)!
...
[ISC license](https://github.com/brronsuite/brond/blob/master/LICENSE).  This is
