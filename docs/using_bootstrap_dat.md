...
5. [How do I use bootstrap.dat with brond?](#Importing)

<a name="What" />

### 1. What is bootstrap.dat?

It is a flat, binary file containing brocoin blockchain data starting from the
...
block chain from other peers through the Brocoin protocol with no extra
...
through the Brocoin protocol.  Additionally, the chain rules contain hard-coded
...
### 5. How do I use bootstrap.dat with brond?
