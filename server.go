...
import (
	...
	"github.com/brronsuite/brond/addrmgr"
	"github.com/brronsuite/brond/blockchain"
	"github.com/brronsuite/brond/blockchain/indexers"
	"github.com/brronsuite/brond/chaincfg"
	"github.com/brronsuite/brond/chaincfg/chainhash"
	"github.com/brronsuite/brond/connmgr"
	"github.com/brronsuite/brond/database"
	"github.com/brronsuite/brond/mempool"
	"github.com/brronsuite/brond/mining"
	"github.com/brronsuite/brond/mining/cpuminer"
	"github.com/brronsuite/brond/netsync"
	"github.com/brronsuite/brond/peer"
	"github.com/brronsuite/brond/txscript"
	"github.com/brronsuite/brond/wire"
	"github.com/brronsuite/bronutil"
	"github.com/brronsuite/bronutil/bloom"
)
...
// broadcastMsg provides the ability to house a brocoin message to be broadcast
...
// server provides a brocoin server for handling communications to and from
// brocoin peers.
type server struct {
...
// OnTx is invoked when a peer receives a tx brocoin message.  It blocks
// until the brocoin transaction has been fully processed.  Unlock the block
...
// OnBlock is invoked when a peer receives a block brocoin message.  It
// blocks until the brocoin block has been fully processed.
func (sp *serverPeer) OnBlock(_ *peer.Peer, msg *wire.MsgBlock, buf []byte) {
	...
	// until the brocoin block is fully processed and known
	...
	// the brocoin block has been fully processed.
...
// handleGetData is invoked when a peer receives a getdata brocoin message and
...
// OnGetCFilters is invoked when a peer receives a getcfilters brocoin message.
...
// OnGetCFHeaders is invoked when a peer receives a getcfheader brocoin message.
...
// OnGetCFCheckpt is invoked when a peer receives a getcfcheckpt brocoin message.
...
// OnFilterAdd is invoked when a peer receives a filteradd brocoin
	...
	if !cfg.DisableDNSSeed {
		...
		connmgr.SeedFromDNS(activeNetParams.Params, defaultRequiredServices,
			brondLookup, func(addrs []*wire.NetAddress) {
				// Brocoind uses a lookup of the dns seeder here. This
...
// brocoin network type specified by chainParams.  Use start to begin accepting
