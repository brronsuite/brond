// Copyright (c) 2014-2017 The brronsuite developers
...
func (r FutureAddMultisigAddressResult) Receive() (bronutil.Address, error) {
	...
	return bronutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
// Brocoin address for receiving payments to the specified account.
...
// GetAccountAddress returns the current Brocoin address for receiving payments
...
func (r FutureGetAddressesByAccountResult) Receive() ([]bronutil.Address, error) {
	...
	addrs := make([]bronutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := bronutil.DecodeAddress(addrStr,
...
// about the given brocoin address.
...
// ValidateAddress returns information about the given brocoin address.
...
// NOTE: While getinfo is implemented here (in wallet.go), a brond chain server
