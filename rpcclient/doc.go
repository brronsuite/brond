...
/*
Package rpcclient implements a websocket-enabled Brocoin JSON-RPC client.

Overview

This client provides a robust and easy to use client for interfacing with a
Brocoin RPC server that uses a brond/brocoin core compatible Brocoin JSON-RPC
API.  This client has been tested with brond (https://github.com/brronsuite/brond),
btcwallet (https://github.com/btcsuite/btcwallet), and
brocoin core (https://github.com/bitcoin).
...
fall back to HTTP POST and disable TLS to support talking with inferior brocoin
