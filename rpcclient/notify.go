...
//
// NOTE: This is a brond extension ported from github.com/decred/dcrrpcclient
...
// parseBtcdConnectedNtfnParams parses out the connection status of brond
// and btcwallet from the parameters of a brondconnected notification.
