...
// parseShortForm parses a string as as used in the Brocoin Core reference tests
...
// TestCalcSignatureHash runs the Brocoin Core signature hash calculation tests
// in sighash.json.
// https://github.com/brocoin/brocoin/blob/master/src/test/data/sighash.json
