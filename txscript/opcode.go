...
// in brocoin core and in most if not all other references and software related
...
const (
	...
	OP_SMALLINTEGER        = 0xfa // 250 - brocoin core internal
	OP_PUBKEYS             = 0xfb // 251 - brocoin core internal
	OP_UNKNOWN252          = 0xfc // 252
	OP_PUBKEYHASH          = 0xfd // 253 - brocoin core internal
	OP_PUBKEY              = 0xfe // 254 - brocoin core internal
	OP_INVALIDOPCODE       = 0xff // 255 - brocoin core internal
)
...
var opcodeArray = [256]opcode{
	...
	// Brocoin Core internal use opcode.  Defined here for completeness.
