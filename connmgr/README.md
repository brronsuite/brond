...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brronsuite/brond/connmgr)
...
```bash
$ go get -u github.com/brronsuite/brond/connmgr
```
