...
var helpDescsEnUS = map[string]string{
	...
	"scriptpubkeyresult-addresses": "The brocoin addresses associated with this script",
	...
	"decodescriptresult-addresses": "The brocoin addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (brond extension)",
	...
	"getblockchaininforesult-unifiedsoftforks":     "The status of the super-majority soft-forks used by brocoind on or after v0.19.0",
	...
	"unifiedsoftforks-softforks":        "The status of the super-majority soft-forks used by brocoind on or after v0.19.0",
	"unifiedsoftforks-softforks--key":   "softforks",
	"unifiedsoftforks-softforks--value": "An object describing an active softfork deployment used by brocoind on or after v0.19.0",
	"unifiedsoftforks-softforks--desc":  "JSON object describing an active softfork deployment used by brocoind on or after v0.19.0",
	...
	"getcurrentnet--synopsis": "Get brocoin network the server is running on.",
	...
	"infowalletresult-balance":         "The total brocoin balance of the wallet",
	...
	"searchrawtransactions-address":     "The Brocoin address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (brond does not yet implement this parameter, so it has no effect)",
	"sendrawtransaction-maxfeerate":    "Used by brocoind on or after v0.19.0",
	...
	"validateaddresschainresult-address": "The brocoin address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Brocoin address to validate",
	...
	"verifymessage-address":   "The brocoin address to use for the signature",
