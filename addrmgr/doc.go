...
/*
Package addrmgr implements concurrency safe Brocoin address manager.

Address Manager Overview

In order maintain the peer-to-peer Brocoin network, there needs to be a source
of addresses to connect to as nodes come and go.  The Brocoin protocol provides
