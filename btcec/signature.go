...
// used in Brocoin signature scripts.
//
...
// case in step 1.6. This counter is used in the brocoin compressed signature
// format and thus we match brocoind's behaviour here.
...
func SignCompact(curve *KoblitzCurve, key *PrivateKey,
	...
	// brocoind checks the bit length of R and S here. The ecdsa signature
