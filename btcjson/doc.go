...
/*
Package btcjson provides primitives for working with the brocoin JSON-RPC API.
...
Unfortunately, the original Brocoin JSON-RPC API (and hence anything compatible
