...
// a chain server with brond extensions.
...
// standard Brocoin command.  It is an extension for brond.
type DebugLevelCmd struct {
	LevelSpec string
}

// NewDebugLevelCmd returns a new DebugLevelCmd which can be used to issue a
// debuglevel JSON-RPC command.  This command is not a standard Brocoin command.
