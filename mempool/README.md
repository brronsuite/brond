...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brronsuite/brond/mempool)

Package mempool provides a policy-enforced pool of unmined brocoin transactions.

A key responsbility of the brocoin network is mining user-generated transactions
...
package for any projects needing the ability create an in-memory pool of brocoin
...
```bash
$ go get -u github.com/brronsuite/brond/mempool
```
