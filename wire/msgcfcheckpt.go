// Copyright (c) 2018 The brronsuite developers
...
// MsgCFCheckpt implements the Message interface and represents a brocoin
...
// NewMsgCFCheckpt returns a new brocoin cfheaders message that conforms to
