...
// MsgAlert  implements the Message interface and defines a brocoin alert
// message.
//
// This is a signed message that provides notifications that the client should
// display if the signature matches the key.  brocoind/brocoin-qt only checks
...
// NewMsgAlert returns a new brocoin alert message that conforms to the Message
