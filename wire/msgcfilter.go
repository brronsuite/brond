...
// MsgCFilter implements the Message interface and represents a brocoin cfilter
...
// from BtcDecode in that BtcDecode decodes from the brocoin wire protocol as
...
// NewMsgCFilter returns a new brocoin cfilter message that conforms to the
