// Copyright (c) 2014-2016 The brronsuite developers
...
// MsgReject implements the Message interface and represents a brocoin reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	...
	// RejectVersion.
	if pver >= RejectVersion {
		// Unfortunately the brocoin protocol does not enforce a sane
...
// NewMsgReject returns a new brocoin reject message that conforms to the
