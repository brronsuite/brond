...
// a single brocoin headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a brocoin headers
...
// NewMsgHeaders returns a new brocoin headers message that conforms to the
