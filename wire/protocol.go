...
// ServiceFlag identifies services supported by a brocoin peer.
...
// BitcoinNet represents which brocoin network a message belongs to.
type BitcoinNet uint32

// Constants used to indicate the message brocoin network.  They can also be
// used to seek to the next message when a stream's state is unknown, but
// this package does not provide that functionality since it's generally a
// better idea to simply disconnect clients that are misbehaving over TCP.
const (
	// MainNet represents the main brocoin network.
...
// bnStrings is a map of brocoin networks back to their constant names for
// pretty printing.
