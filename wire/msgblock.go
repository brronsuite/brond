...
// MsgBlock implements the Message interface and represents a brocoin
...
// BtcDecode decodes from the brocoin wire protocol as it was sent across the
...
// the brocoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new brocoin block message that conforms to the
