...
// MsgGetData implements the Message interface and represents a brocoin
...
// NewMsgGetData returns a new brocoin getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new brocoin getdata message that conforms to
