// Copyright (c) 2017 The brronsuite developers
...
const (
	...
	// that can be in a single brocoin cfheaders message.
	MaxCFHeadersPerMsg = 2000
)

// MsgCFHeaders implements the Message interface and represents a brocoin
...
// differs from BtcDecode in that BtcDecode decodes from the brocoin wire
...
// NewMsgCFHeaders returns a new brocoin cfheaders message that conforms to
