...
// MsgInv implements the Message interface and represents a brocoin inv message.
...
// NewMsgInv returns a new brocoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new brocoin inv message that conforms to the
