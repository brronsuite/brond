...
// MsgFilterClear implements the Message interface and represents a brocoin
...
// NewMsgFilterClear returns a new brocoin filterclear message that conforms to the Message
