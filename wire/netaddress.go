...
// maxNetAddressPayload returns the max payload size for a brocoin NetAddress
...
type NetAddress struct {
	...
	// not present in the brocoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The brocoin protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Brocoin protocol mixes little and big endian.
