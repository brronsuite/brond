// Copyright (c) 2016-2017 The brronsuite developers
...
func newMemWallet(net *chaincfg.Params, harnessID uint32) (*memWallet, error) {
	...
	// newly generated brocoin we can spend.
...
// SetRPCClient saves the passed rpc connection to brond as the wallet's
...
// fundTx attempts to fund a transaction sending amt brocoin. The coins are
