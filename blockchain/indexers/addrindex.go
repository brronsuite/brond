// Copyright (c) 2016 The brronsuite developers
...
func (idx *AddrIndex) TxRegionsForAddress(dbTx database.Tx, addr bronutil.Address, numToSkip, numRequested uint32, reverse bool) ([]database.BlockRegion, uint32, error) {
	addrKey, err := addrToKey(addr)
	if err != nil {
		return nil, 0, err
	}
