...
The brocoin block handling and chain selection rules are an integral, and quite
likely the most important, part of brocoin.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
ascertained from the brocoind source code.  At its core, brocoin is a
...
Since this package does not deal with other brocoin specifics such as network
...
This package includes spec changes outlined by the following BIPs:
		...
		BIP0016 (https://en.brocoin.it/wiki/BIP_0016)
		BIP0030 (https://en.brocoin.it/wiki/BIP_0030)
		BIP0034 (https://en.brocoin.it/wiki/BIP_0034)
*/
package blockchain
